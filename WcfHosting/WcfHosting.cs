...
namespace WcfHosting
{
    ...
    /// </summary>
    internal sealed class WcfHosting : StatelessService
    {
        public WcfHosting(StatelessServiceContext context)
            : base(context)
        { }
        ...
        protected override IEnumerable<ServiceInstanceListener> CreateServiceInstanceListeners()
        {
            return new ServiceInstanceListener[] {
                new ServiceInstanceListener(context => GetInstance(context))
            };
        }
